...
from ep1_dataset import AgeDiffSameUniformDiffDataset, AgeDiffMixedUniformDiffDataset, AgeDiffMimicDiffDataset, get_error_constrained_dataset
from Common.Datasets.Morph2.data_parser import DataParser
from ep1_train import train_diff_cls_model_iter


from ep1_model import AgeDiffModel, DiffModelConfigType
...
dataset_sizes = {x: len(image_datasets[x]) for x in ['train', 'val_apref_ds']}#, 'val_apref_all_ds']}
...
shutil.copyfile("ep1_config.py", model_path + "/ep1_config.py")
shutil.copyfile("ep1_dataset.py", model_path + "/ep1_dataset.py")
shutil.copyfile("ep1_model.py", model_path + "/ep1_model.py")
shutil.copyfile("ep1_train.py", model_path + "/ep1_train.py")
shutil.copyfile("ep1_main_training.py", model_path + "/ep1_main_training.py")
# shutil.copyfile("ep1_main_training.ipynb", model_path + "/ep1_main_training.ipynb")
# shutil.copyfile("ep1_main_diff_inference.ipynb", model_path + "/ep1_main_diff_inference.ipynb")
# shutil.copyfile("ep1_main_e2e_inference.ipynb", model_path + "/ep1_main_e2e_inference.ipynb")
...
criterion_in_range_est = nn.BCEWithLogitsLoss().to(device)
