...
class Morph2ClassifierDataset3(Dataset):
	...
	def __getitem__(self, idx):
		...
		indep_image = self.transform(orig_image)

		sample = {'image': image, 'classification_label': label, 'age': age, 'idx' : idx, 'indep_image' : indep_image}
