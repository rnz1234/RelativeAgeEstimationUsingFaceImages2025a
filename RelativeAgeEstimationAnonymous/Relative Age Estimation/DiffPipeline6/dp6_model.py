...
class AgeDiffModel(nn.Module):
	...
	def __init__(self, 
		...
		if self.agg_type == "maxpool":
			self.aggregation_stage = nn.MaxPool1d(self.num_references,self.num_references)
		elif self.agg_type == "avgpool":
			self.aggregation_stage = nn.AvgPool1d(self.num_references,self.num_references)
	...
	def forward(self, input_images, p=0.5):
		...
		elif self.agg_type == "maxpool" or self.agg_type == "avgpool":
