...
TASK_TYPE = "rangeall" # "range4to10" / "range0to3" / "range0to10" / "rangeall" / "train_range0to10_test_all"
SETTING_TYPE = "real" # "real" / "test"
...
if TASK_TYPE == "range0to3":
    ...
    AGE_DIFF_LEARN_RADIUS_LO = 0                    # DO NOT CHANGE !
elif TASK_TYPE == "train_range0to10_test_all":
    APREF_VLD_SET_AGE_DIFF_LEARN_RADIUS_HI = 10      # the uppermost of the range for the apref validation group 
    APREF_VLD_SET_AGE_DIFF_LEARN_RADIUS_LO = 0      # the lowermost of the range for the apref validation group
    AGE_DIFF_LEARN_RADIUS_HI = 10 #35 #10            # this is the uppermost value of the range the model learns
    AGE_DIFF_LEARN_RADIUS_LO = 0                    # DO NOT CHANGE !
...
NUM_EPOCHS = 300 #60
NUM_ITERS = int(1.5e5)
LEARNING_RATE = 0.0004 #0.000003 #0.0003 #03
...
NUM_OF_WORKERS_DATALOADER = 8
if ENABLE_DEBUG_BREAKPOINTS:
    NUM_OF_WORKERS_DATALOADER = 0

NUM_OF_WORKERS_DATALOADER_VLD = 8
if ENABLE_DEBUG_BREAKPOINTS:
    NUM_OF_WORKERS_DATALOADER_VLD = 0


OPTIMIZER = "RangerLars" #"RangerLars" # "RangerLars" / "Adam"
SCHEDULER = "ReduceLROnPlateau+GradualWarmupScheduler"

REDUCE_LR_ON_PLATEAU_FACTOR = 0.5 
REDUCE_LR_ON_PLATEAU_PATIENCE = 16 
REDUCE_LR_ON_PLATEAU_MIN_LR = 0.00001

#SCHEDULER = "CosineAnnealingLR+GradualWarmupScheduler" # "ReduceLROnPlateau+GradualWarmupScheduler"  / "CosineAnnealingLR+GradualWarmupScheduler" # "CosineAnnealingLR+GradualWarmupScheduler" # "NoScheduler" # "MultiStepLR"
...
#from dp7_model import DiffModelConfigType

#DIFF_MODEL_CONFIG_TYPE = DiffModelConfigType.AddedEmbeddingAndMlpHeadWithDiffHead #AddedEmbeddingAndMlpHead

ADDED_EMBED_LAYER_SIZE = 2048 #256
FC_2ND_LAYER_SIZE = 1024 #128
AGG_TYPE = "fc" # "fc" / "maxpool" / "avgpool"
