...
if __name__ == "__main__":
	...
	x_test_shuffled, y_test_shuffled = utils.shuffle(x_test, y_test)
	...
	pipeline = AgePredictBasicPipeline(
						...
						TransformerModel,
						AgeTransformer,
						DiffPipeline1Model, #AgeDiffModelNonOpt, #AgeDiffModel,
						False, #cfg.IS_ORDINAL_REG,
						no_age_transformer_init=True)


	diff_pipeline_confusion_matrix_analysis(pipeline, data_loaders['val'], device, dataset_sizes['val'])
