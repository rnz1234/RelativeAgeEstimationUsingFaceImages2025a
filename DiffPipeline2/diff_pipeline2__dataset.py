...
class DiffPipeline2Dataset(Dataset):
    def __init__(self,
    ...
    def __len__(self):
        return len(self.actual_batst_set_metadata)
    ...
    def __getitem__(self, idx):
        ...
        orig_image = self.actual_batst_set_images[idx]

        orig_image = Image.fromarray(orig_image)
        
        image = self.transform(orig_image)
        metadata = json.loads(self.actual_batst_set_metadata[idx])
