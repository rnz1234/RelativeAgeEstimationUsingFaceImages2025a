...
if __name__ == "__main__":
    ...
    model = DiffPipeline3Model(age_interval=cfg.AGE_INTERVAL, 
                            min_age=cfg.MIN_AGE, 
                            max_age=cfg.MAX_AGE, 
                            age_radius=cfg.AGE_RADIUS, 
                            device=device)
    ...
    shutil.copyfile("diff_pipeline3__config.py", model_path + "/config.py")
