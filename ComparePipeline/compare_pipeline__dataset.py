...
class ComparePipelineSameUniformDiffDataset(Dataset):
    def __init__(self,
    ...
    def __getitem__(self, idx):
        ...
        if label - ref_image_label < 0:
            pair_label = 0
        elif label == ref_image_label:
            pair_label = 1
        elif label - ref_image_label > 0:
            pair_label = 2
        else:
            print("bug - aborting")
            exit()
...
class ComparePipelineMixedUniformDiffDataset(Dataset):
    def __init__(self,
...
class ComparePipelineMimicDiffDataset(Dataset):
    def __init__(self,
                batrn_set_images,               # basic aligned train images 
                batrn_set_metadata,             # basic aligned train metadata (labels)
                batst_set_images,               # basic aligned test images
